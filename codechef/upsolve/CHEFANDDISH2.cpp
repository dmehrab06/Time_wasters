...
int main(){
    ...
    while(t--){
        ...
        cin>>dish;
        int l=dish.size();
        if(l%2){ //ekhane genjam ase ababc / acbab eigula yes hobe , dekhte hobe
            //int letcoun[26];
            /*for(int i=0;i<26;++i){
                letcoun[i]=0;
            }
            ...
            if(f){
                ...
                int leftboundary=l/2;
                string a="";
                for(int i=0;i<=leftboundary;++i){
                    a+=dish[i];
                }
                string b="";
                for(int i=leftboundary+1;i<l;++i){
                    b+=dish[i];
                }
                bool flag=strbina(a,b);
                if(flag){
                    printf("YES\n");
                }
                else{
                    int leftboundary=l/2-1;
                    string a="";
                    for(int i=0;i<=leftboundary;++i){
                        a+=dish[i];
                    }
