        ...
        for(int i=0;i<n;++i){
            ...
            for(int j=0;j<m;++j){
                ...
                if(b>maxcount1){
                    ...
                    maxcount1=b;
                    maxval1=matrix[i][j];
                    printf("maxcount1 affected in column %d\n",j);
                }
                else if(b>maxcount2 && matrix[i][j]!=maxval1){
                    maxcount2=b;
                    maxval2=matrix[i][j];
                    printf("maxcount2 affected in column %d\n",j);
                }
                printf("after column %d\n",j);
                printf("maxval1: %d, maxval2: %d\n",maxval1,maxval2);
                printf("maxcount1: %d, maxcount2: %d\n",maxcount1,maxcount2);
            }
            rowval1[i]=maxval1;
            rowval2[i]=maxval2;
            rowidx1[i]=maxcount1;
        ...
        for(int j=0;j<m;++j){
            ...
            for(int i=0;i<n;++i){
                ...
                if(b>maxcount1){
                    ...
                    maxcount1=b;
                    maxval1=matrix[i][j];
                    printf("maxcount1 affected in row %d\n",i);
                }
                else if(b>maxcount2 && matrix[i][j]!=maxval1){
                    maxcount2=b;
                    maxval2=matrix[i][j];
                    printf("maxcount2 affected in row %d\n",i);
                }
                printf("after row %d\n",j);
                printf("maxval1: %d, maxval2: %d\n",maxval1,maxval2);
                printf("maxcount1: %d, maxcount2: %d\n",maxcount1,maxcount2);
