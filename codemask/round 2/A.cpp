...
int main(){
    int englishdate=1,englishmonth=1,englishyear=1972;
    int bangladate=18,banglamonth=9,banglayear=1378;
    map<string,date>etobdate;
    while(1){
        date e(englishdate,englishmonth,englishyear);
        string ed=datetostring(e);
        date bd;
        bd.d=bangladate;
        bd.m=banglamonth;
        bd.y=banglayear;
        ...
        if(englishdate==29){
            if(englishmonth==2){
                if(!isleap(englishyear)){
                    englishdate=1;
                    englishmonth+=1;
                }
            }
        }
        else if(englishdate==30){
            if(englishmonth==2){
                englishdate=1;
                englishmonth+=1;
            }
        }
        else if(englishdate==31){
            if(englishmonth==4 || englishmonth==6 || englishmonth==9 || englishmonth==11){
                englishdate=1;
                englishmonth+=1;
            }
        }
        ...
        if(bangladate==31){
            ...
            else if(banglamonth>5){
                banglamonth+=1;
                bangladate=1;
            }
        }
        else if(bangladate>31){
            banglamonth+=1;
            bangladate=1;
        }
        if(banglamonth>12){
    ...
    while(t--){
        ...
        scanf("%d %d %d",&d,&m,&y);
        date e(d,m,y);
        string ddd=datetostring(e);
        date pp;
        pp=etobdate[ddd];
        printf("Case %d: %d, ",cs++,pp.d);
        if(pp.m==1){
            printf("Baishakh");
        }
        else if(pp.m==2){
