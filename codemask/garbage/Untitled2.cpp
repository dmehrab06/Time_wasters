...
int main(){
    ...
    while(t--){
        ...
        while(n--){
            ...
            cin>>h>>t;
            myitem houseman(h,t);
            allhouse.push_back(houseman);
        }
        sort(allhouse.begin(),allhouse.end(),mycompare);
        if(n%3==0){
            ...
            int f=1;
            for(int i=0;i<sz;++i){
                myitem cur=allhouse[i];
                if(cur.type=="Good"){
                    goodp=i;
                    int badf=0;
                    while(++badp<sz){
                        if(allhouse[badp].type=="Bad" && allhouse[badp].house>allhouse[goodp].house){
                            badf=1;
                            break;
                        }
                    }
                    ...
                    int uglyf=0;
                    while(++uglyp<sz){
                        if(allhouse[uglyp].type=="Ugly" && allhouse[uglyp].house>allhouse[goodp].house && allhouse[uglyp].house!=allhouse[badp].house){
                            uglyf=1;
                            break;
                        }
                    }
