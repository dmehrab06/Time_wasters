...
int calczero(int x){
    int z=(x/5)+(x/25)+(x/125)+(x/625)+(x/3125)+(x/15625)+(x/78125)+(x/390625);
    return z;
}
vector<int>sorted;
//vector<int>real;
...
int main(){
                    ...
                    while(1){
                        ...
                        if(c==b){
                            ...
                            if(id==-1){
                                ...
                                aidx=bidx;
                                bidx=id;
                                //string used=stringpair(aidx,bidx);
                                dp[aidx][bidx]=1;
                                a=b;
                                b=c;
                            }
        ...
        for(int i=0;i<n;++i){
            for(int j=i+1;j<n;++j){
                ...
                //string pairs=stringpair(j,i);
                else if(dp[j][i]!=-1)continue;
                else{
                    int a=sorted[j];
                    int b=sorted[i];
                    int len=2;
