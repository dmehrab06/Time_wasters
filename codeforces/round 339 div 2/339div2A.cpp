...
int main(){
    ...
    cin>>x1>>y1>>x2>>y2;
    long long int st=(x2-x1)/2;
    long long int ft=st+1;
    long long int firstcellbottomy=y1;
    long long int firstcelltopy=y2;
    if((x1+y1)%2){
        firstcellbottomy+=1;
    }
    if((x1+y2)%2){
    ...
    long long int firsttotal=(firstcelltopy-firstcellbottomy)/2+1;
    if(firsttotal<0){
        firsttotal=0;
    }
    long long int sectotal=0;
    if(st>0){
        long long int secondcellbottomy=y1;
        long long int secondcelltopy=y2;
        if((x1+1+y1)%2){
            secondcellbottomy+=1;
        }
        if((x1+1+y2)%2){
        ...
        sectotal=(secondcelltopy-secondcellbottomy)/2+1;
        if(sectotal<0){
            sectotal=0;
        }
    }
    cout<<firsttotal*ft+sectotal*st<<"\n";
